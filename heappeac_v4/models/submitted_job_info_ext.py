...
class SubmittedJobInfoExt(object):
    ...
    def __init__(self, id=None, name=None, state=None, creation_time=None, submit_time=None, start_time=None, end_time=None, total_allocated_time=None, tasks=None):  # noqa: E501
