...
class JobManagementApi(object):
    ...
    def heappe_job_management_get_allocated_nodes_ips_post(self, **kwargs):  # noqa: E501
        """Get allocated node IP addresses  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.heappe_job_management_get_allocated_nodes_ips_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AllocatedNodesIPsModel body:
        :return: list[str]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.heappe_job_management_get_allocated_nodes_ips_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.heappe_job_management_get_allocated_nodes_ips_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def heappe_job_management_get_allocated_nodes_ips_post_with_http_info(self, **kwargs):  # noqa: E501
        """Get allocated node IP addresses  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.heappe_job_management_get_allocated_nodes_ips_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method heappe_job_management_get_allocated_nodes_ips_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def heappe_job_management_get_current_info_for_job_post(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param CurrentInfoForJobModel body:
        :return: SubmittedJobInfoExt
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def heappe_job_management_list_jobs_for_current_user_post(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ListJobsForCurrentUserModel body:
        :return: list[SubmittedJobInfoExt]
                 If the method is called asynchronously,
                 returns the request thread.
        """
