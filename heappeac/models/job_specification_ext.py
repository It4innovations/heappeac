...
class JobSpecificationExt(object):
    ...
    def __init__(self, name=None, project=None, waiting_limit=None, walltime_limit=None, notification_email=None, phone_number=None, notify_on_abort=None, notify_on_finish=None, notify_on_start=None, cluster_id=None, file_transfer_method_id=None, environment_variables=None, tasks=None):  # noqa: E501
