...
class TaskSpecificationExt(object):
    ...
    def __init__(self, name=None, min_cores=None, max_cores=None, walltime_limit=None, required_nodes=None, priority=None, job_arrays=None, is_exclusive=None, is_rerunnable=None, standard_input_file=None, standard_output_file=None, standard_error_file=None, progress_file=None, log_file=None, cluster_task_subdirectory=None, cluster_node_type_id=None, command_template_id=None, cpu_hyper_threading=None, environment_variables=None, depends_on=None, template_parameter_values=None):  # noqa: E501
