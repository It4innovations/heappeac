...
class FileTransferMethodExt(object):
    ...
    swagger_types = {
        ...
        'file_transfer_cipher_type': 'FileTransferCipherTypeExt',
    ...
    attribute_map = {
        ...
        'file_transfer_cipher_type': 'FileTransferCipherType',
        'credentials': 'Credentials'
    }

    def __init__(self, server_hostname=None, shared_basepath=None, protocol=None, proxy_connection=None, file_transfer_cipher_type=None, credentials=None):  # noqa: E501
        """FileTransferMethodExt - a model defined in Swagger"""  # noqa: E501
        self._server_hostname = None
        self._shared_basepath = None
        self._protocol = None
        self._proxy_connection = None
        self._file_transfer_cipher_type = None
        ...
        if file_transfer_cipher_type is not None:
            self.file_transfer_cipher_type = file_transfer_cipher_type
    ...
    @property
    def file_transfer_cipher_type(self):
        """Gets the file_transfer_cipher_type of this FileTransferMethodExt.  # noqa: E501


        :return: The file_transfer_cipher_type of this FileTransferMethodExt.  # noqa: E501
        :rtype: FileTransferCipherTypeExt
        """
        return self._file_transfer_cipher_type

    @file_transfer_cipher_type.setter
    def file_transfer_cipher_type(self, file_transfer_cipher_type):
        """Sets the file_transfer_cipher_type of this FileTransferMethodExt.


        :param file_transfer_cipher_type: The file_transfer_cipher_type of this FileTransferMethodExt.  # noqa: E501
        :type: FileTransferCipherTypeExt
        """

        self._file_transfer_cipher_type = file_transfer_cipher_type
