...
class CommandTemplateExt(object):
    ...
    def __init__(self, id=None, name=None, description=None, code=None, template_parameters=None):  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this CommandTemplateExt.  # noqa: E501


        :return: The code of this CommandTemplateExt.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this CommandTemplateExt.


        :param code: The code of this CommandTemplateExt.  # noqa: E501
        :type: str
        """
